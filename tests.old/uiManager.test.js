...
describe('UI Manager', () => {
	...
	const uiManager = require('../public/js/utils/uiManager.js');
	
	// Get references to mocked dependencies
	const mockGameStateManager = require('../public/js/utils/gameStateManager.js');
	const mockSoundManager = require('../public/js/utils/soundManager.js');
