...
describe('Pawn Promotion', () => {
	...
	describe('moveChessPiece', () => {
		it('should promote a pawn after 8 moves', () => {
			...
			expect(promotedPiece.promoted).toBe(true);
			...
			expect(promotionEvent.data.playerId).toBe(playerId);
			expect(promotionEvent.data.pieceId).toBe('pawn1');
			expect(promotionEvent.data.oldType).toBe('pawn');
			expect(promotionEvent.data.newType).toBe('knight');
		});
		...
		it('should not promote a pawn with fewer than 8 moves', () => {
			...
			expect(movedPiece.promoted).toBeUndefined();
	...
	describe('GameManager Pawn Promotion', () => {
		it('should promote a pawn after 8 moves', () => {
			...
			expect(promotionEvent).toBeDefined();
			expect(promotionEvent.data.playerId).toBe(playerId);
			expect(promotionEvent.data.pieceId).toBe(`${playerId}_pawn1`);
			expect(promotionEvent.data.oldType).toBe('pawn');
			expect(promotionEvent.data.newType).toBe('knight');
		});
