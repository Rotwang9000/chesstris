...
describe('Game State Manager', () => {
	...
	import gameStateManager from '../public/js/utils/gameStateManager.js';
	
	// Mock dependencies - references to retain access to the mock functions
	import mockNetwork from '../public/js/utils/network.js';
	import mockGameRenderer from '../public/js/utils/gameRenderer.js';
